...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-[#1a1a1a] py-12 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          ...
          <motion.h3
            ...
            viewport={{ once: true }}
            className="font-serif text-3xl text-[#C9A84C] mb-2"
          >
            Ananya
          </motion.h3>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-[#666] text-xs mb-8"
          >
            Founded by <span className="text-[#C9A84C]">Sanjukta Sahu</span>
          </motion.p>

          {/* Decorative line */}
          <div className="w-24 h-px bg-gradient-to-r from-transparent via-[#C9A84C] to-transparent mb-8" />
          ...
          >
            ...
            <Link
              href="https://www.facebook.com/people/Ananya-Beauty-Spa/100063512363479/"
              target="_blank"
              className="w-10 h-10 border border-[#2a2a2a] flex items-center justify-center text-[#a8a8a8] hover:border-[#C9A84C] hover:text-[#C9A84C] transition-all duration-300"
              aria-label="Facebook"
            >
          ...
          >
            {["Home", "About", "Services", "Gallery", "Contact"].map((link) => (
              <Link
                ...
                className="text-[#a8a8a8] hover:text-[#C9A84C] transition-colors duration-300"
              >
                {link}
              </Link>
            ))}
